...
//*************************************************************
// Rule
//1.  use App\Http\Requests\TeachersValidation; //Add Controller
//2.  public function store( TeachersValidation $request ){ //example
//*************************************************************

class TeachersValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"login_id" => "required|max:255", //string('login_id',255)
