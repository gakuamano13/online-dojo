...
//*************************************************************
// Rule
//1.  use App\Http\Requests\LikesValidation; //Add Controller
//2.  public function store( LikesValidation $request ){ //example
//*************************************************************

class LikesValidation extends FormRequest
{
    /**
