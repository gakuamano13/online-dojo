...
//*************************************************************
// Rule
//1.  use App\Http\Requests\NavigatorsLessonsValidation; //Add Controller
//2.  public function store( NavigatorsLessonsValidation $request ){ //example
//*************************************************************

class NavigatorsLessonsValidation extends FormRequest
{
    /**
