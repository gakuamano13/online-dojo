...
//*************************************************************
// Rule
//1.  use App\Http\Requests\StudentsValidation; //Add Controller
//2.  public function store( StudentsValidation $request ){ //example
//*************************************************************

class StudentsValidation extends FormRequest
{
    /**
