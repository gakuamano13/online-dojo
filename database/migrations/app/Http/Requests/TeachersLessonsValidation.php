...
//*************************************************************
// Rule
//1.  use App\Http\Requests\TeachersLessonsValidation; //Add Controller
//2.  public function store( TeachersLessonsValidation $request ){ //example
//*************************************************************

class TeachersLessonsValidation extends FormRequest
{
    /**
